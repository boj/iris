...
lean_object* initialize_iris_x2dkernel_IrisKernel_Rules(uint8_t builtin);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_iris_x2dkernel_IrisKernel_Rules(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_iris_x2dkernel_IrisKernel_Properties(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_iris_x2dkernel_IrisKernel_Consistency(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
